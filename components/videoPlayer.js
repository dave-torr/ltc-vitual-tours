...
function TourPlayer(props){
    return(
        <>
            <div className={styles.virtuaTourVid}>
                <video width="320" height="240" src="/videos/virtualTours.mp4" type="video/mp4" controls autoPlay/>
            </div>
        </>
    )
}
